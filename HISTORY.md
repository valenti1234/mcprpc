...
- Added `mc-java-automesh`: Java 21 AutoMesh implementation that discovers Java methods, generates JSON Schema, registers tools in `mr-registry`, and serves MCP tools.
