...
var MCPServer = class {
  ...
  constructor(serviceName, version) {
    ...
    this.server.setRequestHandler(import_types2.ListToolsRequestSchema, async () => {
    ...
    this.server.setRequestHandler(import_types2.CallToolRequestSchema, async (request) => {
